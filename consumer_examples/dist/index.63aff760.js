...
console.log(phrase1);
const mySyringeUnits = (0, _dermtools.syringeUnits)("dysport", 2.5, 0.5);
const phrase2 = `A 0.5mL syringe contains ${mySyringeUnits}U of Dysport diluted with 2.5mL.`;
console.log(phrase2);
console.log(" ");
console.log((0, _dermtools.gcs)(0, 5, 6)); // Glasgow Coma Scale calculation
console.log((0, _dermtools.pgcs)(1, 3, 4)); // pediatric Glasgow Coma Scale calculation
console.log((0, _dermtools.si)(95, 120)); // adult shock index score
console.log((0, _dermtools.sipa)(16, 105, 125)); // children's shock index score
...
const patientPASI = (0, _dermtools.pasi)(headAreaValues, armsAreaValues, trunkAreaValues, legsAreaValues).toFixed(2);
...
const fluids24h = (0, _dermtools.parkland)(80, 1005);
...
parcelHelpers.export(exports, "pgcs", ()=>pgcs);
var gcs = function(eye_response, verbal_response, motor_response) {
    if (eye_response > 4 || eye_response < 0 || verbal_response > 5 || verbal_response < 0 || motor_response > 6 || motor_response < 0) return -1;
    return {
...
var pgcs = function(eye_response, verbal_response, motor_response) {
    if (eye_response > 4 || eye_response < 1 || verbal_response > 5 || verbal_response < 1 || motor_response > 6 || motor_response < 1) return -1;
    return {
        score: eye_response + verbal_response + motor_response,
        e: eye_response,
        v: verbal_response,
...
},{}],"blabg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "si", ()=>si);
parcelHelpers.export(exports, "sipa", ()=>sipa);
var si = function(heart_rate, systolic_BP) {
    return heart_rate / systolic_BP;
};
var sipa = function(age, max_heart_rate, min_systolic_BP) {
    if (age < 4 || age > 16) return -1;
    return "sipa function called";
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cgikL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "brandUnits", ()=>brandUnits);
parcelHelpers.export(exports, "syringeUnits", ()=>syringeUnits);
var brandUnits = function(brandName) {
    if (brandName === void 0) brandName = "botox";
...
var syringeUnits = function(brandName, dilution, syringeVolume) {
    if (brandName === void 0) brandName = "botox";
    if (dilution === void 0) dilution = 2.5;
    if (syringeVolume === void 0) syringeVolume = 0.5;
    var brand = brandName.trim().toLowerCase();
